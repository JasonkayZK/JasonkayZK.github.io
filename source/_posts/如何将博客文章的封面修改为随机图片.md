...
以本博客使用到的api为例: [https://acg.yanwz.cn/api.php](https://acg.yanwz.cn/api.php)

可以在末尾添加`?x`, 其中x是一个数字, 如: https://acg.yanwz.cn/api.php?233
...
-   直接获取图片
    ...
    -   二次元动漫: https://acg.yanwz.cn/api.php
