...
![qrcode_1.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_1.png)

在三个角绘制7×7查找器图案（此时会覆盖一些基准模块）：

![qrcode_2.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_2.png)

在查找器相邻区域绘制临时的格式占位图案：

![qrcode_3.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_3.png)
...
![qrcode_4.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_4.png)

根据Z字形扫描顺序和最终码字序列的位值绘制数据/ECC模块：

![qrcode_5.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_5.png)
...
![qrcode_6.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_6.png)

将数据、ECC和剩余其他部分和Mask进行异或：

![qrcode_7.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_7.png)

紧靠查找器绘制实际的格式位：

![qrcode_8.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_8.png)
...
![qrcode_9.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_9.png)

垂直相同颜色的区域（每个至少5个单位长）：

![qrcode_10.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_10.png)

2×2颜色相同的区域：

![qrcode_11.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_11.png)

水平和查找器相同的样式：

![qrcode_12.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_12.png)

垂直和查找器相同的样式：

![qrcode_13.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/qrcode_13.png)
