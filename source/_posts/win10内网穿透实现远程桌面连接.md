...
![frp1.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp1.png)

点击注册账号，填写资料注册账号；

注册完成后的界面长这样，左边是菜单栏：

![frp2.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp2.png)
...
![frp3.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp3.png)
...
![frp4.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp4.png)

把“允许远程协助连接这台计算机”前面的框勾上，下面选择“允许远程连接到此计算机”：

![frp5.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp5.png)

然后点“选择用户”，注意看红框圈出的位置，这是被控电脑的用户名，待会用得上：

![frp6.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp6.png)
...
>
>   ![frp7.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp7.png)
>
...
![frp8.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp8.png)

软件大概长这样，用刚才网页上的访问密钥进行登陆：

![frp9.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp9.png)

登陆完成后，点左边菜单栏的隧道，可以看到目前已经配置了一个隧道：

![frp10.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp10.png)
...
![frp11.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp11.png)

点击创建，会弹出创建成功提示框，点击是，会多出一条记录：

![frp12.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp12.png)

最后，点击开启刚才的隧道，会弹出日志信息，记住这个日志信息上面的IP或者服务器域名，待会通过这个IP连接被控电脑：

![frp13.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/frp13.png)
