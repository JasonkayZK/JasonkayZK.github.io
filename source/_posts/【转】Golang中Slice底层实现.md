...
![slice1.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice1.png)
...
![slice2.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice2.png)
...
![slice3.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice3.png)
...
![slice4.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice4.png)

 这里是用字面量创建的一个 len = 6，cap = 6 的切片，这时候数组里面每个元素的值都初始化完成了。

<font color="#f00">**需要注意的是 [ ] 里面不要写数组的容量，因为如果写了个数以后就是数组了，而不是切片了。**</font>

![slice5.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice5.png)
...
![slice6.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice6.png)
...
![slice7.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice7.png)
...
![slice8.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice8.png)
...
![slice9.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice9.png)
...
![slice10.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice10.png)
...
![slice11.png](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/slice11.png)
