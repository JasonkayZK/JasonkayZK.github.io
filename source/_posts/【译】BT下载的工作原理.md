...
![bt1.png](https://jasonkay_image.imfast.io/images/bt1.png)
...
![bt2.svg](https://jasonkay_image.imfast.io/images/bt2.svg)



而半中心化的对等网络是：拥有一个或多个权限比其他大多数对等点更高的对等网络。

![bt3.svg](https://jasonkay_image.imfast.io/images/bt3.svg)
...
![bt4.png](https://jasonkay_image.imfast.io/images/bt4.png)
...
![bt5.png](https://jasonkay_image.imfast.io/images/bt5.png)

对等点将会连接到种子对应的IP并下载文件的**一个部分**。

![bt6.png](https://jasonkay_image.imfast.io/images/bt6.png)
...
![bt7.svg](https://jasonkay_image.imfast.io/images/bt7.svg)
...
![bt8.svg](https://jasonkay_image.imfast.io/images/bt8.svg)
...
![bt9.svg](https://jasonkay_image.imfast.io/images/bt9.svg)
...
![bt10.svg](https://jasonkay_image.imfast.io/images/bt10.svg)
...
![bt11.svg](https://jasonkay_image.imfast.io/images/bt11.svg)

假设我们正在从2个对等点下载，而还有另外1个我们未从中下载的对等点。

当请求的对等点缺少相应的子块时，BT协议会将请求广播给集群中所有对等点，而这有助于我们获取文件的最后一块。

![bt12.svg](https://jasonkay_image.imfast.io/images/bt12.svg)

如果对等点缺少子块，他们会将消息发送回我们。

一旦一个子块到达，我们将发送一条取消消息，告诉其他对等方忽略我们的请求。

![bt13.svg](https://jasonkay_image.imfast.io/images/bt13.svg)
...
![bt14.svg](https://jasonkay_image.imfast.io/images/bt14.svg)
...
![bt15.png](https://jasonkay_image.imfast.io/images/bt15.png)
...
![bt16.svg](https://jasonkay_image.imfast.io/images/bt16.svg)
...
![bt17.svg](https://jasonkay_image.imfast.io/images/bt17.svg)
