...
>   <red>**注：`--privileged`和`/usr/sbin/init`是必须的，否则会存在容器权限不足的问题！**</font>
...
>   <red>**如果集群是第一次启动，需要在big-data-1节点格式化NameNode（注意格式化之前，一定要先停止上次启动所有namenode和datanode进程，然后再删除data和log数据）！**</font>
...
>
>   <red>**注：如果你的宿主机是虚拟机或者其他服务器，可以在宿主机配置Nginx反向代理，进而在本机直接访问宿主机即可！**</font>
>
>   具体方法：
>
>   ```bash
...
>   效果如下：
>
>   ![](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/big-data-1.png)
...
>   <red>**测试之前请确保已经停止并清除了所有正在Run的容器！**</font>
