...
title: Bash命令自动补全实战
toc: true
cover: 'https://acg.yanwz.cn/api.php?123'
...
<red>**我们可以看到，虽然我们在输入了nev字母后再触发了自动补全，显示的补全列表之前的一样并没有做自动过滤！**</font>

这是为什么呢？

-   <red>**COMPREPLY变量的内容总是会显示，补全函数需要自己处理其中的内容；**</font>
-   <red>**如果COMPREPLY变量中只有一个元素，那么这个词会自动补全到命令之后**</font>（由于目前的实现总是返回相同的三个词，不会触发这个功能）；
