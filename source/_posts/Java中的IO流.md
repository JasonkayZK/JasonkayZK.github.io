...
![InputStream.png](https://jasonkay_image.imfast.io/images/InputStream.png)

**② OutputStream：字节输出流**

![OutputStream.png](https://jasonkay_image.imfast.io/images/OutputStream.png)

③ Reader：字符输入流

![Reader.png](https://jasonkay_image.imfast.io/images/Reader.png)

④ Writer：字符输出流

![Writer.png](https://jasonkay_image.imfast.io/images/Writer.png)
...
![整个IO流的结构.png](https://jasonkay_image.imfast.io/images/整个IO流的结构.png)
...
![装饰者模式.png](https://jasonkay_image.imfast.io/images/装饰者模式.png)
...
![装饰者模式2.png](https://jasonkay_image.imfast.io/images/装饰者模式2.png)
