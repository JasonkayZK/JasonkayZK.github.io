...
![InputStream.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/InputStream.png)

**② OutputStream：字节输出流**

![OutputStream.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/OutputStream.png)

③ Reader：字符输入流

![Reader.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/Reader.png)

④ Writer：字符输出流

![Writer.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/Writer.png)
...
![整个IO流的结构.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/整个IO流的结构.png)
...
![装饰者模式.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/装饰者模式.png)
...
![装饰者模式2.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/装饰者模式2.png)
