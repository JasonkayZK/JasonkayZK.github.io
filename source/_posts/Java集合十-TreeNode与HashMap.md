...
![树.png](https://jasonkay_image.imfast.io/images/树.png)
...
![平衡二叉树.png](https://jasonkay_image.imfast.io/images/平衡二叉树.png)
...
![红黑树.jpeg](https://jasonkay_image.imfast.io/images/红黑树.jpeg)
...
![Rehash1.png](https://jasonkay_image.imfast.io/images/Rehash1.png)
...
![Rehash2.png](https://jasonkay_image.imfast.io/images/Rehash2.png)

但是如果现在我们有20个对象呢？？？50个对象呢？？？100个，1000个对象呢？？？

每个槽位需要承受的对象数量会越来越多，如果只是一味地挂对象，而不采取合适的策略确定要加上去的对象到底放在哪个位置的话，很有可能出现下面这种状况

![Rehash3.png](https://jasonkay_image.imfast.io/images/Rehash3.png)

 那么当我们查找一个对象的时候可能遇到这种情况，

![Rehash4.png](https://jasonkay_image.imfast.io/images/Rehash4.png)

这样的话，查询时间复杂度为线性, 效率十分低下，我们希望加上去的对象在整个数组上呈均匀分布的趋势，这样就不会出现某个槽承受了很多对象但是有的槽位承受很少对象，甚至只有一个对象的情况

下面是我们希望的结果。

![Rehash5.png](https://jasonkay_image.imfast.io/images/Rehash5.png)
...
![Rehash6.png](https://jasonkay_image.imfast.io/images/Rehash6.png)

假如我们的数组大小是16，那么我们要根据hashCode 确定好数组下标，下标的范围是0~15.

该怎么确定呢？我们可以用直接映射的方法

![Rehash7.png](https://jasonkay_image.imfast.io/images/Rehash7.png)
...
![Rehash8.png](https://jasonkay_image.imfast.io/images/Rehash8.png)
...
![Rehash9.png](https://jasonkay_image.imfast.io/images/Rehash9.png)
...
![Rehash10.png](https://jasonkay_image.imfast.io/images/Rehash10.png)
...
![Rehash11.png](https://jasonkay_image.imfast.io/images/Rehash11.png)
