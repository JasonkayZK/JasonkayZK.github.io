...
![包含空内容节点的集群](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/包含空内容节点的集群.png)
...
![拥有一个索引的单节点集群](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/拥有一个索引的单节点集群.png)
...
![拥有两个节点的集群](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/拥有两个节点的集群.png)
...
![拥有三个节点的集群](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/拥有三个节点的集群.png)
...
![将参数number_of_replicas调大到2](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/将参数number_of_replicas调大到2.png)
...
![关闭了一个节点后的集群](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/关闭了一个节点后的集群.png)
