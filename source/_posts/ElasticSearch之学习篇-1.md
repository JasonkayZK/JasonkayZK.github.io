...
![包含空内容节点的集群](https://jasonkay_image.imfast.io/images/包含空内容节点的集群.png)
...
![拥有一个索引的单节点集群](https://jasonkay_image.imfast.io/images/拥有一个索引的单节点集群.png)
...
![拥有两个节点的集群](https://jasonkay_image.imfast.io/images/拥有两个节点的集群.png)
...
![拥有三个节点的集群](https://jasonkay_image.imfast.io/images/拥有三个节点的集群.png)
...
![将参数number_of_replicas调大到2](https://jasonkay_image.imfast.io/images/将参数number_of_replicas调大到2.png)
...
![关闭了一个节点后的集群](https://jasonkay_image.imfast.io/images/关闭了一个节点后的集群.png)
