...
![ThreadLocalMap的图示.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/ThreadLocalMap的图示.png)
...
![threadLocal引用示意图.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/threadLocal引用示意图.png)
...
![cleanSomeSlots示意图.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/cleanSomeSlots示意图.png)
...
![cleanSomeSlots执行情景图.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/cleanSomeSlots示意图.png)
...
![向前环形搜索到脏entry，向后环形查找到可覆盖的entry的情况.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/向前环形搜索到脏entry，向后环形查找到可覆盖的entry的情况.png)
...
![前向环形搜索到脏entry,向后环形未搜索可覆盖entry.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/前向环形搜索到脏entry,向后环形未搜索可覆盖entry.png)
...
![前向未搜索到脏entry，后向环形搜索到可覆盖的entry.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/前向未搜索到脏entry，后向环形搜索到可覆盖的entry.png)
...
![前向环形未搜索到脏entry,后向环形查找未查找到可覆盖的entry.png](https://raw.gitmirror.com/JasonkayZK/blog_static/master/images/前向环形未搜索到脏entry,后向环形查找未查找到可覆盖的entry.png)
