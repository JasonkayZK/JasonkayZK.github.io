...
![新闻网站的业务用例.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/新闻网站的业务用例.png)
...
![泛化.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/泛化.png)
...
![实现.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/实现.png)
...
![关联.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/关联.png)
...
![聚合.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/聚合.png)
...
![组合.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/组合.png)
...
![依赖.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/依赖.png)
...
![各种类图关系.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/各种类图关系.png)
...
![对象图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/对象图.jpg)
...
![活动图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/活动图.jpg)
...
![带泳道的活动图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/带泳道的活动图.jpg)
...
![带对象流的活动图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/带对象流的活动图.jpg)
...
![状态图.gif](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/状态图.gif)
...
![序列图-时序图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/序列图-时序图.jpg)
...
![生命线.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/生命线.png)

##### 7.2 同步消息

同步等待消息

![同步消息.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/同步消息.png)

##### 7.3 异步消息

异步发送消息，不需等待

![异步消息.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/异步消息.png)

##### 7.4 注释

![注释.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/注释.png)

##### 7.5 约束

![约束.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/约束.png)
...
![协作图.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/协作图.png)
...
![构件图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/构件图.jpg)
...
![部署图.jpg](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/部署图.jpg)
...
![UML与软件工程.png](https://cdn.jsdelivr.net/gh/jasonkayzk/blog_static@master/images/UML与软件工程.png)
