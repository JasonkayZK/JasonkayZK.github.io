...
![create_string](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/create_string.png)
...
![创建字符串形式](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/创建字符串形式.png)
...
![连接形式创建字符串1](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/连接形式创建字符串1.png)
...
![连接形式创建字符串2](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/连接形式创建字符串2.png)
...
![连接形式创建字符串3](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/连接形式创建字符串3.png)
...
![JDK6的内存模型](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/JDK6的内存模型.png)
...
![JDK7后的内存模型](https://raw.fastgit.org/JasonkayZK/blog_static/master/images/JDK7后的内存模型.png)
